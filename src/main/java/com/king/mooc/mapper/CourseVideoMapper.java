...
public interface CourseVideoMapper extends BaseMapper<CourseVideo> {
    ...
    @Insert("<script>" +
            "INSERT INTO course_video(id,cid,name,path,video_number,play_amount,is_video,img_path)VALUES" +
            ...
            "#{courseVideo.videoNumber},#{courseVideo.playAmount},#{courseVideo.isVideo},#{courseVideo.imgPath})" +
            "</foreach> " +
            "</script>")
